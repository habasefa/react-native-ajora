...
import { Avatar, Day, utils } from "react-native-ajora";
import type {
  DayProps,
  BubbleProps,
  AvatarProps,
...
const Message = (props: Props) => {
  const { currentMessage, nextMessage, previousMessage, containerStyle } =
    props;
  ...
  const marginBottom = useMemo(
    () => (isSameUser(currentMessage, nextMessage) ? 2 : 10),
