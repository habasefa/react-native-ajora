...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const db = new dbService_1.default();
        yield db.initialize();
        try {
            const title = process.argv[2] || "Sample Thread";
            // Create or get thread
            const thread = yield db.getOrCreateThread(title);
                        ...
                        },
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "What Does a Nutritionist Do?| University of Bridgeport",
                                            url: "https://www.bridgeport.edu/news/what-does-a-nutritionist-do/",
                                            description: "<strong>Nutritionists</strong> help clients make informed decisions about food, exercise, and general health. Learn what <strong>a</strong> <strong>nutritionist</strong> <strong>does</strong> on a daily basis.",
                                            profile: {
                                        ...
                                        {
                                            title: "What Does a Nutritionist Do? (Job Duties & Workplaces)",
                                            url: "https://www.allalliedhealthschools.com/nutritionist/nutritionist-careers/",
                                            description: "<strong>Nutritionists</strong> help people achieve their health and wellness goals by creating plans tailored to each client and educating them about nutrition.",
                                            profile: {
                                        ...
                                        {
                                            title: "Dietitians and Nutritionists: What’s the Difference? - GoodRx",
                                            url: "https://www.goodrx.com/well-being/diet-nutrition/dietitian-vs-nutritionist",
                                            description: "Do you need a dietitian or <strong>a</strong> <strong>nutritionist</strong>? Here’s the difference between them, including cost and training.",
                                            profile: {
                                                name: "GoodRx",
                                                url: "https://www.goodrx.com/well-being/diet-nutrition/dietitian-vs-nutritionist",
                                        ...
                                        {
                                            title: "Dietitians and Nutritionists : Occupational Outlook Handbook: : U.S. Bureau of Labor Statistics",
                                            url: "https://www.bls.gov/ooh/healthcare/dietitians-and-nutritionists.htm",
                                            description: "In order to maintain the RDN credential, dietitians and <strong>nutritionists</strong> must complete continuing professional education credits within a designated number of years.  · Many states accept the Certified Nutrition Specialist (CNS) credential or exam for licensure purposes. To qualify for the credential, applicants must have a master’s or doctoral ...",
                                            profile: {
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "Steps to Become a Registered Dietitian Nutritionist (RDN) - Academy of Nutrition and Dietetics",
                                            url: "https://www.eatright.org/become-an-rdn-or-dtr/dietetics-career-path",
                                            description: "The path to becoming a Registered Dietitian Nutritionist (RDN) includes education, supervised practice, and passing the national examination.",
                                            profile: {
                                        ...
                                        {
                                            title: "Registered Dietitian vs. Nutritionist: What’s the Difference?",
                                            url: "https://www.healthline.com/nutrition/dietitian-vs-nutritionist",
                                            description: "A Registered Dietitian has specific, advanced education and training requirements, including a minimum of a bachelor's degree and a supervised internship.",
                                            profile: {
                                                name: "Healthline",
                                    ...
                                    output: [
                                        {
                                            ...
                                            description: "The CNS certification is for advanced personalized nutrition practitioners. Requirements include a master's or doctoral degree and a significant amount of supervised practice.",
                                            profile: {
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "What Is a CSSD? - Commission on Dietetic Registration",
                                            url: "https://www.cdrnet.org/certifications/cssd",
                                            description: "The CSSD is the premier professional credential for sports dietitians.",
                                            profile: {
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "State Licensure - Academy of Nutrition and Dietetics",
                                            url: "https://www.eatrightpro.org/advocacy/licensure/state-licensure-information",
                                            description: "Information on licensure, certification, or registration for RDNs by state.",
                                            profile: {
                                                name: "Academy of Nutrition and Dietetics",
                                        ...
                                        },
                                        {
                                            ...
                                            description: "List of states that recognize the CNS certification for licensure to practice nutrition.",
                                            profile: {
                                                name: "Board for Certification of Nutrition Specialists (BCNS)",
                                                url: "https://nutritionspecialists.org/",
                                                long_name: "nutritionspecialists.org",
                ...
                },
                {
                    ...
                    parts: [
                        ...
                        },
                        {
                            functionCall: {
                                args: {
                                    query: "Texas licensure requirements for MNT pre-diabetes RD vs CNS",
                                },
                                name: "search_web",
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "Texas Health and Safety Code, Chapter 701, Subchapter C",
                                            url: "https://www.statutes.legis.state.tx.us/Docs/HS/htm/HS.701.htm",
                                            description: "Texas has a specific licensing law for dietitians (Licensed Dietitian - LD), and practice without a license is generally prohibited.",
                                            profile: {
                                        ...
                                        },
                                        {
                                            ...
                                            description: "The Texas Department of Licensing and Regulation (TDLR) regulates Licensed Dietitians (LD).",
                                            profile: {
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "What is a CDCES? - Certification Board for Diabetes Care and Education (CBDCE)",
                                            url: "https://www.cbdce.org/certifications/cdces",
                                            description: "The CDCES certification is for health professionals who are specialists in diabetes care, education, and management.",
                                            profile: {
                                                name: "CBDCE",
                    ...
                    parts: [
                        {
                            functionResponse: {
                                ...
                                response: {
                                    output: [
                                        {
                                            title: "Find an Expert - Academy of Nutrition and Dietetics - Texas",
                                            url: "https://www.eatright.org/find-an-expert?state=TX&specialty=diabetes",
                                            description: "Directory of RDs in Texas specializing in diabetes care.",
                                            profile: {
                                                name: "Academy of Nutrition and Dietetics",
                                                url: "https://www.eatright.org/",
                                                long_name: "eatright.org",
            ...
            for (const m of messages) {
                yield db.addMessage(m);
            }
            const saved = yield db.getMessages(thread_id);
